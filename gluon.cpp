...
Gluon::Gluon(FourMomentum& four_momentum_in, std::vector<std::string> colours_in)
    : Particle(0, four_momentum_in, 0, 1)
...
void Gluon::antiparticle() 
{
    ...
    //changing the colours to anticolours (and vice-versa)
    for(int i = 0; i < 2; ++i)
    {
...
{
    //checking there is 1 colour and 1 anticolour
